...
public class SenderAsyncTask extends AsyncTask<String, String, String>
{
    ...
    protected String doInBackground(String... params) {
        try {
            ...
            String htmlText2 = "<p ALIGN=\"center\"><img  width=\"200\" height=\"200\" src=\"https://firebasestorage.googleapis.com/v0/b/formutecitsu-18.appspot.com/o/formuTec500.png?alt=media&token=4af62430-a772-4984-91ac-aa3494c2d2a1\"></p>";
            String htmlText =
                    "<body> " +
