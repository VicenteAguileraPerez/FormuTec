...
public class StaticsMenus
{
    ...
    public static List<String> algebra = new ArrayList<>(Arrays.asList(
            ...
            "Propiedades de sumatoria y protuctoria",
    ...
    public static List<String> derivadas = new ArrayList<>(Arrays.asList(
            ...
            "Fórmulas de derivacion de valor absoluto",
            "Fórmulas de derivación de logaritmos y exponeciales",
            "Fórmulas de derivación de funciones trigonometricas",
    ...
    public static List<String> integrales = new ArrayList<>(Arrays.asList(
        ...
        "Fórmulas de integración con funciones trigonométricas inversas",
        "Fórmulas de integración con au+b",
        "Fórmulas de integración con √(au+b)",
        ...
        "Fórmulas de integración con u³+a³",
        "Fórmulas de integración con u⁴+a⁴",
        "Fórmulas de integración con sen(au)",
        "Fórmulas de integración con cos(au)",
        "Fórmulas de integración con sen(au) y cos(au)",
        "Fórmulas de integración con tan(au)",
        "Fórmulas de integración con cot(au)",
        "Fórmulas de integración con sec(au)",
        ...
        "Aplicación de la integral área bajo la curva",
        "Aplicación de la integral área entre curvas planas",
        "Aplicación de la integral longitud de arco",
        "Aplicación de la integral volúmenes de revolución",
    ...
    public static List<String> vectorial = new ArrayList<>(Arrays.asList(
            ...
            "Curvatura",
            "Limites de sumas, productos y cocientes",
            "Derivadas parciales",
            "Regla de la cadena y derivada implícita",
            "Derivadad parciales de orden superior",
    ...
    public static List<String> finacieras = new ArrayList<>(Arrays.asList(
            ...
            "Depreciación Método de sumas de dígitos"
